  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white dark:bg-black text-black dark:text-white transition-all duration-300">
      <div className="max-w-3xl text-center space-y-10">
        ...
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolore earum sapiente voluptatibus asperiores cupiditate, esse repellendus quibusdam maxime hic corrupti.</p>
